...
from sklearn.metrics import confusion_matri, mean_squared_error, r2_score
...
import COVID19_vaccination_in_pregnancy.utilities.medication_orders
...
# finalize formatting dataframes for COVID-19 severity analyses
...
# evaluate max oxygen device, oxygen assistance, and vasopressor use during COVID-19
...
# evaluate WHO COVID-19 Severity Score
...
# evaluate max patient class, inpatient rates, and hospitalization rates during COVID-19
...
print(calc_fishers_exact_test_not_simulated(dict_vaccinated_two_shots_inpatient, dict_vaccinated_boosted_inpatient))dict_vaccinated_two_shots_hospitalization = determine_hospitalization_status(df_breakthrough_two_shots_final)
...
# print summary statistics concerning medication and diagnoses during COVID-19 for each cohort
...
print('# Min Number of Unique Inpatient Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].unique_inpatient_medication_count.min()))
print('# Max Number of Unique Inpatient Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].unique_inpatient_medication_count.max()))
print('# Median Number of Unique Inpatient Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].unique_inpatient_medication_count.median()))
print('# IQR Number of Unique Inpatient Medications Vaccinated (mRNA): ' + str(stats.iqr(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].unique_inpatient_medication_count)))
print('# Vaccinated (mRNA) vs Unvaccinated Unique Inpatient Medication Count p-value: ' + str(run_mann_whitney_u_test(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1], df_unvaccinated_final[df_unvaccinated_final['max_patient_class'] > 1], 'unique_inpatient_medication_count')[1]))
print('\n')

print('# Min Number of Unique Outpatient Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final.unique_outpatient_medication_count.min()))
print('# Max Number of Unique Outpatient Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final.unique_outpatient_medication_count.max()))
print('# Median Number of Unique Outpatient Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final.unique_outpatient_medication_count.median()))
print('# IQR Number of Unique Outpatient Medications Vaccinated (mRNA): ' + str(stats.iqr(df_breakthrough_mrna_final.unique_outpatient_medication_count)))
print('# Vaccinated (mRNA) vs Unvaccinated Unique Outpatient Medication Count p-value: ' + str(run_mann_whitney_u_test(df_breakthrough_mrna_final, df_unvaccinated_final, 'unique_outpatient_medication_count')[1]))
print('\n')

print('# Min Number of Unique Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final.unique_medication_count.min()))
print('# Max Number of Unique Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final.unique_medication_count.max()))
print('# Median Number of Unique Medications Vaccinated (mRNA): ' + str(df_breakthrough_mrna_final.unique_medication_count.median()))
print('# IQR Number of Unique Medications Vaccinated (mRNA): ' + str(stats.iqr(df_breakthrough_mrna_final.unique_medication_count)))
print('# Vaccinated (mRNA) vs Unvaccinated Unique Medication Count p-value: ' + str(run_mann_whitney_u_test(df_breakthrough_mrna_final, df_unvaccinated_final, 'unique_medication_count')[1]))
print('\n')

print('# Min Number of Unique Diagnoses Vaccinated (mRNA) Inpatient: ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_unique_diagnoses.min()))
print('# Max Number of Unique Diagnoses Vaccinated (mRNA) Inpatient: ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_unique_diagnoses.max()))
print('# Median Number of Unique Diagnoses Vaccinated (mRNA) Inpatient: ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_unique_diagnoses.median()))
print('# IQR Number of Unique Diagnoses Vaccinated (mRNA) Inpatient: ' + str(stats.iqr(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_unique_diagnoses)))
print('# Vaccinated (mRNA) vs Unvaccinated Unique Diagnoses Count Inpatient p-value: ' + str(run_mann_whitney_u_test(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1], df_unvaccinated_final[df_unvaccinated_final['max_patient_class'] > 1], 'n_unique_diagnoses')[1]))
print('\n')

print('# Min Number of Total Diagnoses Vaccinated (mRNA) Inpatient: ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_total_diagnoses.min()))
print('# Max Number of Total Diagnoses Vaccinated (mRNA) Inpatient: ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_total_diagnoses.max()))
print('# Median Number of Total Diagnoses Vaccinated (mRNA) Inpatient: ' + str(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_total_diagnoses.median()))
print('# IQR Number of Total Diagnoses Vaccinated (mRNA) Inpatient: ' + str(stats.iqr(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1].n_total_diagnoses)))
print('# Vaccinated (mRNA) vs Unvaccinated Total Diagnoses Count Inpatient p-value: ' + str(run_mann_whitney_u_test(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1], df_unvaccinated_final[df_unvaccinated_final['max_patient_class'] > 1], 'n_total_diagnoses')[1]))
...
print('# Vaccinated (mRNA) vs Unvaccinated Matched Total Diagnoses Count Inpatient p-value: ' + str(run_mann_whitney_u_test(df_breakthrough_mrna_final[df_breakthrough_mrna_final['max_patient_class'] > 1], df_unvaccinated_matched_final[df_unvaccinated_matched_final['max_patient_class'] > 1], 'n_total_diagnoses')[1]))
